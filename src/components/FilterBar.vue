<template>
  <div class="flex justify-end">
    <div class="relative flex items-center gap-2">
      <button class="ui-btn" @click="toggleDatePopover">
        📅 {{ dateSummary }}
      </button>
      <button class="ui-btn" @click="toggleFilterPopover">
        ⛃ Filter
      </button>
      <button class="ui-btn-ghost" @click="resetToLatestYear">Reset</button>
      ...
      <div v-if="showFilterPopover" class="absolute right-0 top-11 z-40 w-[22rem] rounded-lg border border-slate-200 bg-white p-3 shadow-lg">
        <p class="text-xs font-semibold text-slate-600">Add filters</p>
